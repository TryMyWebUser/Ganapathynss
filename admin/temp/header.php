            ...
            <div class="d-flex align-items-center gap-1">
                ...
                <div class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="pages-calendar.html"> <iconify-icon icon="solar:calendar-bold-duotone" class="align-middle me-2 fs-18"></iconify-icon><span class="align-middle">My Schedules</span> </a>

                        <a class="dropdown-item" href="pages-pricing.html"> <iconify-icon icon="solar:wallet-bold-duotone" class="align-middle me-2 fs-18"></iconify-icon><span class="align-middle">Pricing</span> </a>
                        <a class="dropdown-item" href="pages-faqs.html"> <iconify-icon icon="solar:help-bold-duotone" class="align-middle me-2 fs-18"></iconify-icon><span class="align-middle">Help</span> </a>
                        ...
                        <a class="dropdown-item text-danger" href="auth-signin.html"> <iconify-icon icon="solar:logout-3-bold-duotone" class="align-middle me-2 fs-18"></iconify-icon><span class="align-middle">Logout</span> </a>
                    </div>
                </div>
            </div>
        </div>
